...
from optcom.components.generic_filter import GenericFilter
...
mod_comps = ['CW', 'Fiber', 'FiberYb', 'FiberCoupler', 'Gaussian',
             'GaussianFilter', 'GenericFilter', 'FlatTopFilter',
             'IdealAmplifier', 'IdealCombiner', 'IdealCoupler', 'IdealDivider',
             'IdealFilter', 'IdealIsolator', 'IdealPhaseMod', 'IdealMZM',
             'LoadFieldFromFile', 'LoadField', 'SaveFieldToFile', 'SaveField',
             'Sech', 'Soliton']
