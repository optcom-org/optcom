...
class Gain(AbstractEffectTaylor):
    r"""The fiber gain effect.
    ...
    def __init__(self, g: Union[List[float], Callable], order_taylor: int = 1,
                 start_taylor: int = 0, skip_taylor: List[int] = [],
                 UNI_OMEGA: bool = True) -> None:
        r"""
        Parameters
        ----------
        g :
            The derivatives of the gain coefficients.
        ...
        order_taylor :
            The order of g coefficients Taylor series expansion to
            take into account. (will be set to the length of the g
        ...
        """
        super().__init__(g, order_taylor, start_taylor, skip_taylor, UNI_OMEGA)
    # ==================================================================
    def op(self, waves: np.ndarray, id: int,
           corr_wave: Optional[np.ndarray] = None) -> np.ndarray:
        """The operator of the gain effect."""
