...
class CGNLSE(AbstractCNLSE):
    ...
    def __init__(self, nbr_fibers: int = 2,
                 ...
                 XPM: bool = False, FWM: bool = False, ASYM: bool = True,
                 COUP: bool = True, medium: str = cst.DEF_FIBER_MEDIUM,
        ...
        for i in range(nbr_fibers):
            self._eqs[i].append(GNLSE(alpha_[i], alpha_order, beta_[i],
                                      beta_order, gamma_[i], sigma_[i], tau_1,
                                      tau_2, f_R, core_radius_[i], NA_[i], ATT,
