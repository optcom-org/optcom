...
# physic constants
LIGHT_SPEED: float = 1.0e-3 * scipy_cst.c   # nm / ps
PI: float = scipy_cst.pi
KB: float = scipy_cst.Boltzmann * 1e6 # J / K = m^2 kg s^-2 K^-1 -> nm^2 kg ps^-2 K^-1
H: float = scipy_cst.Planck * 1e6    # m^2 kg s -> nm^2 kg ps
